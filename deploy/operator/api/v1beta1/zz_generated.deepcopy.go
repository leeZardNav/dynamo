...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ContainerArgsPatch) DeepCopyInto(out *ContainerArgsPatch) {
	*out = *in
	if in.Append != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ContainerArgsPatch.
func (in *ContainerArgsPatch) DeepCopy() *ContainerArgsPatch {
	if in == nil {
		return nil
	}
	out := new(ContainerArgsPatch)
	in.DeepCopyInto(out)
	return out
}
...
func (in *DynamoComponentDeploymentSharedSpec) DeepCopyInto(out *DynamoComponentDeploymentSharedSpec) {
	*out = *in
	...
	if in.ContainerArgsPatches != nil {
		in, out := &in.ContainerArgsPatches, &out.ContainerArgsPatches
		*out = make([]ContainerArgsPatch, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
